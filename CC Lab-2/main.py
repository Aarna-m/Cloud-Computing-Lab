...
def startup():
    ...
    db.execute("CREATE INDEX IF NOT EXISTS idx_events_id ON events(id)")      # for /events
    db.execute("CREATE INDEX IF NOT EXISTS idx_reg_user ON registrations(username)")  # for /my-events
    db.commit()
